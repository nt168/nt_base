...
// #ifndef _WINDOWS
// static const char	*nt_get_log_level_ref_string(int loglevel)
// {
// 	switch (loglevel)
// 	{
...
// {
// 	return nt_get_log_level_ref_string(*plog_level);
// }
...
// 			nt_log(LOG_LEVEL_INFORMATION, "cannot decrease log level:"
// 					" minimum level has been already set");
// 			break;
// 		case LOG_LEVEL_DEC_SUCCEED:
// 			nt_log(LOG_LEVEL_INFORMATION, "log level has been decreased to %s",
// 					nt_get_log_level_string());
// 			break;
// 		case LOG_LEVEL_INC_SUCCEED:
// 			nt_log(LOG_LEVEL_INFORMATION, "log level has been increased to %s",
// 					nt_get_log_level_string());
// 			break;
// 		case LOG_LEVEL_INC_FAIL:
// 			nt_log(LOG_LEVEL_INFORMATION, "cannot increase log level:"
...
// 	nt_snprintf(log_component_name, sizeof(log_component_name), "[%s] ", name);
...
// 		{
// 			nt_log(LOG_LEVEL_INFORMATION, "%scannot decrease log level:"
// 					" minimum level has been already set", component->name);
// 		}
// 		else
// 		{
// 			component->level += direction;
// 			nt_log(LOG_LEVEL_INFORMATION, "%slog level has been decreased to %s",
// 					component->name, nt_get_log_level_ref_string(component->level));
// 		}
// 	}
// 	else
// 	{
...
// 		{
// 			nt_log(LOG_LEVEL_INFORMATION, "%scannot increase log level:"
// 					" maximum level has been already set", component->name);
// 		}
// 		else
// 		{
// 			component->level += direction;
// 			nt_log(LOG_LEVEL_INFORMATION, "%slog level has been increased to %s",
// 					component->name, nt_get_log_level_ref_string(component->level));
// 		}
// 	}
// }
...
// 	fprintf(stderr, "%s [%li]: ", (NULL != get_progname_cb) ? get_progname_cb() : "", nt_get_thread_id());
